   ...
   public boolean admin;
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
       frmProducto producto = new frmProducto();
        if(userAdmin.equals(txtUsername.getText()) && passwordAdmin.equals(txtPassword.getText())){
            admin = true;
            producto.ShowButtons(admin);
            producto.setVisible(true);
            dispose();
        }
        else if (user.equals(txtUsername.getText()) && password.equals(txtPassword.getText())){
            admin = false;            
            producto.ShowButtons(admin);
            producto.setVisible(true);
            dispose();
